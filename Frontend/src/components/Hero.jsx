  ...
  return (
    <section className='relative bg-hero bg-cover bg-center bg-no-repeat h-screen w-full'>
        <div className='max_padd_container relative top-32 xs:top-52'>
            ...
            <p className='text-gray-50 regular-16 mt-6 max-w-[32rem]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis, fugit laborum! Placeat atque voluptatum 
                aperiam ipsa quas esse libero culpa dolores, maiores porro sunt? Velit eveniet accusamus unde. Fugiat, cum!
            </p>
